...
exports.index = asyncHandler(async(req, res, next)=>{
    ...
    res.render("index", {title: "Harvey Hurricane's Local Library Home", book_count: numBooks, book_instance_count: numBookInstances, book_instance_available_count: numAvailableBookInstances, author_count: numAuthors, genre_count: numGenres});
});
